...
// who calls this strategy method
class BasicPigStrategy implements Strategy<PigState, Boolean> {
    ...
    public Boolean action(PigState s)
    {
        return s.score[s.player] + s.turnScore >= Pig.Goal || s.turnScore >= holdAt ? Pig.Hold : Pig.Roll;
    }
...
// DO I NEED TO IMPLEMENT EVALUATE AND WRITE SOMETHING SPECIIFIC FOR WARLIGHT
